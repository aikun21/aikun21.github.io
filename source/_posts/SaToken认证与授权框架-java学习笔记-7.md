...
由于MIS系统中的权限是固定的，而角色是可以动态增减的。如果我们用 @sacheckRole 注解，规定访问Web方法的用户必须具备什么角色。如果将来该角色被删除掉，难道我们还要修改大量的Web方法注解吗?就像下面的Web方法，如果角色1被删除，难不成还要让程序员重新修改代码，重新打包程序，重新发布项目吗?
